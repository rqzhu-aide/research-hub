...
1. **The new mechanism or framework**: what is the core mathematical novelty?
   ...
   algebraic identity, a new geometric insight, or a theoretical framework from
   a different field applied in a new way?
2. **Target and obstacle**: what mathematical quantity or property matters, and
   why do existing formulations fail to capture or achieve it?
3. **Unique position**: what does this mechanism enable mathematically that no
...
Think broadly and creatively. A mechanism from a different mathematical area, a
surprising algebraic identity, or a novel dynamical structure all belong here.
Do not limit yourself to minor variations of known formulas.

## Round 2 and later: Cross-pollinate
Read the other roles' ideas. Then:

1. Can a mechanism you proposed combine with a computational approach the data
   analyst suggested?
2. Does the research lead's framing reveal a mathematical opportunity you hadn't
   considered?
3. Refine your ideas based on cross-role insights, and propose new mathematical
   ideas sparked by the other perspectives.
4. Where two ideas have mathematical overlap or tension, describe it without
   eliminating either.
